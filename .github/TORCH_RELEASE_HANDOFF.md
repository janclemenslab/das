...
- `v0.32.12` is the final TensorFlow-backed release on `master`.
...
4. Add a short README migration note that `das==0.32.12` remains available for users who need TensorFlow.
