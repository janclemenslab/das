...
def train(*, data_dir: str, model_name: str = 'tcn', nb_filters: int = 16, kernel_size: int = 3,
          ...
          out_activation: str = 'softmax', mask_input: int = None,
    ...
    Args:
        ...
        out_activation (str): 'categorical crossentropy' for classification, 'mse' for regression. Defaults to 'categorical crossentropy'.
    ...
    params.update({'nb_freq': d['train']['x'].shape[1], 'nb_channels': d['train']['x'].shape[-1], 'nb_classes': d['train']['x'].shape[-1],
